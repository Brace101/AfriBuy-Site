...
const testimonials = [
  { id: 1, name: 'Sarah M.', rating: 5, text: "I'm blown away by the quality and style of the clothes I received from AfriBuy." },
  { id: 2, name: 'Alex K.', rating: 5, text: 'Finding clothes that align with my personal style used to be a challenge until I discovered AfriBuy.' },
  { id: 3, name: 'James L.', rating: 5, text: "As someone who's always on the lookout for unique fashion pieces, I'm thrilled." },
  { id: 4, name: 'Maya P.', rating: 5, text: 'AfriBuy has become my go-to for building out a wardrobe I actually feel like myself in.' },
